...
> Hi all, you can call me **Tama**, I am a Software Engineer that interested to **Software Development** and **Computer Vision**. I am currently working as a corpoboy that build some stuff using React, Next, Node JS, and Spring

- ⚙️ I usually do some stuff's using `Javascript`, `PHP`, `Flutter`, `Python`, and `Tensorflow`
- 🌱 I'm currently diving in `Next JS`, `Spring`, and `Node JS`
